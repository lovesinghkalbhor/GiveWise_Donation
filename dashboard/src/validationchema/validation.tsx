...
const AddDonationValidationSchemaIMPS = Yup.object({
  purpose: Yup.string()
    .required("IMPS number is required")
    .matches(/^IMPS-\d{12}$/, "IMPS must start with IMPS- and be 12 digits") // it should be number after IMPS-
    .max(500, "Purpose cannot exceed 500 characters"),
  // .matches(
  //   /^[1-9]\d{9}$/,
  //   "Phone Number must be a valid 10-digit Indian number"
...
export {
  ...
  AddDonationValidationSchemaIMPS,
};
