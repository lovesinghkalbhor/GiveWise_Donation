      ...
      <div className="grid grid-cols-12 lg:h-56 h-fit gap-5">
        <div className="lg:col-span-7 col-span-12 rounded-3xl shadow-mainShadow bg-primaryColor text-white p-8">
          <h3 className="font-semibold text-2xl mb-5">
            Welcome to Givewise {user.name}
          </h3>
          <p className="text-sm">
            GiveWise is your smart donation tracking partner. Here, you can
            easily manage all donation records — whether in cash, IMPS, or kind
            and generate official receipts in seconds. Together, let's make
            every contribution count and bring positive change to society.
          </p>
        </div>
